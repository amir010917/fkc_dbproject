...
if (isset($_POST['submit'])) {
    ...
    $update_query = "UPDATE product SET product_name='$product_name', product_category='$product_category', product_description='$product_description', product_price='$product_price' WHERE id_product = '$ProductId'";
            ...
            <div class="container-fluid">
                ...
                <form action="" id="manage-user" method="POST">	
                    <div class="form-group">
                        ...
                        <input type="text" name="pname" id="pname" class="form-control" name="pname" value="<?php echo $row['product_name']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="phone">Category</label>
                        <input type="text" name="category" id="category" class="form-control" name="category" value="<?php echo $row['product_category']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="phone">Price</label>
                        <input type="text" name="price" id="price" class="form-control" name="price" value="<?php echo $row['product_price']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="Address">Description</label>
                        <textarea class="form-control" id="description" rows="3" name="description"><?php echo $row['product_description']; ?></textarea>
                    </div>
