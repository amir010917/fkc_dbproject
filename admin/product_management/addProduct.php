...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO product (product_name, product_category, product_description, product_price) 
    VALUES ('$product_name', '$product_category', '$product_description', '$product_price')";
    if ($conn->query($query) === TRUE) {
        echo ' <script>alert("Product inserted successfully.!");</script>';
        header("Location: index.php");
    } else {
        echo ' <script>alert("Error inserting Product:");</script>' . $conn->error;
    }
            ...
            <div class="container-fluid">
                ...
                <form action="" id="manage-user" method="POST">	
                    <div class="form-group">
                        ...
                        <input type="text" name="pname" id="pname" class="form-control" name="pname">
                    </div>
                    <div class="form-group">
                        <label for="phone">Category</label>
                        <input type="text" name="category" id="category" class="form-control" name="category">
                    </div>
                    <div class="form-group">
                        <label for="phone">Price</label>
                        <input type="text" name="price" id="price" class="form-control" name="price">
                    </div>
                    <div class="form-group">
