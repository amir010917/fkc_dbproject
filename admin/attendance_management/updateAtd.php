...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT a.*, s.* 
            ...
            INNER JOIN staff AS s ON a.id_staff = s.id_staff 
            WHERE a.id_attendance = $id_attendance";
...
if (isset($_POST['submit'])) {
    ...
    $update_query = "UPDATE attendance SET attendance_date='$attendance_date' WHERE id_attendance = $id_attendance";
...
<!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Staff Attendance Details</h1>
                            ...
                            <div class="container-fluid">
                                ...
                                <form action="" id="manage-user" method="POST">	     
                                        ...
                                        <div class="form-group">
                                            <label for="attandance_date">Attendance Date</label>
                                                <input type="date" class="form-control form-control-user" id="attendance_date" name="attendance_date" value="<?php echo $user['attendance_date']; ?>"  >
                                        </div>        
