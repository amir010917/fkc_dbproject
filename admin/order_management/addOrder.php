...
if (isset($_POST['submit'])) {
    ...
    $update_query = "INSERT INTO agent_order (id_agent, id_product, order_date, order_quantity, order_totalprice, order_status) 
    VALUES ('$id_agent','$id_product','$order_date','$order_quantity','$order_totalprice', '$order_status')";
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                 ...
                 <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Order Form</h1>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <select name="id_agent" id="id_agent" class="custom-select">
                                                ...
                                                while($row = mysqli_fetch_array($sql_run)){
                                                    echo '<option value="' . $row['id_agent'] . '">' . $row['agent_fname'] . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="order_date" id="order_date" class="form-control" name="order_date">
                                        </div>
                                        <div class="form-group">
                                            <label for="id_product" aria-placeholder="Product Name">Product</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="order_quantity" id="order_quantity" class="form-control" name="order_quantity">
                                        </div>
                                        <div class="form-group">
                                            <label for="order_totalprice">Order Total Price</label>
                                            <input type="number" name="order_totalprice" id="order_totalprice" class="form-control" name="order_totalprice">
                                        </div>
                                        <div class="form-group">
