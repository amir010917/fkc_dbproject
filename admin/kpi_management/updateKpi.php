...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM kpi JOIN staff ON kpi.id_staff = staff.id_staff WHERE id_kpi = $id_kpi";
...
if (isset($_POST['submit'])) {
    ...
    $kpi_task = $_POST['kpi_task'];
    $kpi_due = $_POST['kpi_due'];
    $kpi_status = $_POST['kpi_status'];

    $update_query = "UPDATE kpi SET id_staff='$id_staff', kpi_task='$kpi_task', kpi_due='$kpi_due', kpi_status='$kpi_status' WHERE id_kpi = $id_kpi";
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                 ...
                 <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">KPI Details</h1>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <form action="" id="manage-user" method="POST">	
                                        <div class="form-group">
                                            <label for="id_staff" aria-placeholder="Staff Name">Staff Name</label>
                                            <select name="id_staff" id="id_staff" class="custom-select">
                                            <option value="<?php echo $user['staff_fname']; ?>"><?php echo $user['staff_fname']; ?></option>
                                                <?php
                                                $sql = "SELECT * FROM staff;";
                                                $sql_run = mysqli_query($conn, $sql);
                                                while($row = mysqli_fetch_array($sql_run)){
                                                    echo '<option value="' . $row['id_staff'] . '">' . $row['staff_fname'] . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="kpi_task">KPI Task</label>
                                            <textarea class="form-control" id="kpi_task" rows="3" name="kpi_task"><?php echo $user['kpi_task']; ?></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="kpi_due">Kpi Due</label>
                                            <input type="date" name="kpi_due" id="kpi_due" class="form-control" name="kpi_due" value="<?php echo $user['kpi_due']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="kpi_status">KPI Status</label>
                                            <input type="text" name="kpi_status" id="kpi_status" class="form-control" name="kpi_status" value="<?php echo $user['kpi_status']; ?>">
                                        </div>
