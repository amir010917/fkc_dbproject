...
$query = "SELECT * FROM kpi JOIN staff ON kpi.id_staff = staff.id_staff";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO `kpi` (`id_staff`, `kpi_task`, `kpi_due`, `kpi_status`) 
    VALUES ('$id_staff', '$kpi_task', '$kpi_due', '$kpi_status')";
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                 ...
                 <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">KPI Form</h1>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <form action="" id="manage-user" method="POST">	
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="kpi_task" id="kpi_task" class="form-control" name="kpi_task">
                                        </div>
                                        <div class="form-group">
                                            <label for="kpi_due">Kpi Due</label>
                                            <input type="date" name="kpi_due" id="kpi_due" class="form-control" name="kpi_due">
                                        </div>
                                        <div class="form-group">
                                            <label for="kpi_status">KPI Status</label>
                                            <input type="text" name="kpi_status" id="kpi_status" class="form-control" name="kpi_status">
                                        </div>
