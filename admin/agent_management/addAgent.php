...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO agent (agent_fname, agent_lname, agent_email, agent_phone, agent_address) 
    VALUES ('$firstName', '$lastName', '$email', '$phone', '$address')";
    if ($conn->query($query) === TRUE) {
        echo ' <script>alert("Agent inserted successfully.!");</script>';
        header("Location: index.php");
    } else {
        echo ' <script>alert("Error inserting Agent:");</script>' . $conn->error;
    }
...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">Agent Account Registration</h1>
