...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO vendor (vendor_companyname, vendor_category, vendor_address, vendor_picname, vendor_picphone) 
    VALUES ('$cname', '$category', '$address', '$pic_name', '$pic_num')";
    if ($conn->query($query) === TRUE) {
        echo ' <script>alert("Vendor inserted successfully.!");</script>';
        header("Location: index.php");
    } else {
        echo ' <script>alert("Error inserting Vendor:");</script>' . $conn->error;
    }
...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">Vendor Account Registration</h1>
            ...
            <div class="container-fluid">
                ...
                <form action="" id="manage-user" method="POST">	
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="Address" id="Address" class="form-control" name="Address">
                    </div>
                    <div class="form-group">
                        <label for="phone">PIC Name</label>
                        <input type="text" name="pic_name" id="pic_name" class="form-control" name="pic_name">
                    </div>
                    <div class="form-group">
                        <label for="phone">Contact Number</label>
                        <input type="text" name="pic_num" id="pic_num" class="form-control" name="pic_num">
                    </div>
