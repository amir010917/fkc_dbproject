...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM vendor WHERE id_vendor = $IdVendor";
...
if (isset($_POST['submit'])) {
    ...
    $update_query = "UPDATE vendor SET vendor_companyname='$cname', vendor_category='$category', vendor_address='$address', vendor_picname='$pic_name', vendor_picphone='$pic_num' WHERE id_vendor = '$IdVendor'";
  
    if (mysqli_query($conn, $update_query)) {
        // Redirect to the vendor management page or display a success message
...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">Vendor Account Details</h1>
            ...
            <div class="container-fluid">
                ...
                <form action="" id="manage-user" method="POST">	
                    ...
                    <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control form-control-user" id="cname" name="cname" value="<?php echo $row['vendor_companyname']; ?>">
                        </div>
                        <div class="col-sm-6">
                            <label for="name">Category</label>
                            <input type="text" class="form-control form-control-user" id="category" name="category" value="<?php echo $row['vendor_category']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="email">Address</label>
                        <input type="text" name="Address" id="Address" class="form-control" name="Address" value="<?php echo $row['vendor_address']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="phone">PIC Name</label>
                        <input type="text" name="pic_name" id="pic_name" class="form-control" name="pic_name" value="<?php echo $row['vendor_picname']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="phone">Contact Number</label>
                        <input type="text" name="pic_num" id="pic_num" class="form-control" name="pic_num" value="<?php echo $row['vendor_picphone']; ?>">
                    </div>
