...
if (isset($_POST['submit'])) {
    ...
    $update_query = "UPDATE staff SET staff_username='$username', staff_password='$password', staff_fname='$FName', staff_lname='$LName', staff_email='$email', staff_phone='$phone', staff_address='$address', staff_role='$role' WHERE id_staff = $IdStaff";
...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">Staff Account Details</h1>
            ...
            <div class="container-fluid">
                ...
                <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control form-control-user" id="username" name="username" value="<?php echo $row['staff_username']; ?>">
                        </div>
                        <div class="col-sm-6">
                            <label for="name">Password</label>
                            <input type="text" class="form-control form-control-user" id="password" name="password" value="<?php echo $row['staff_password']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <label for="name">First Name</label>
                            <input type="text" class="form-control form-control-user" id="FName" name="FName" value="<?php echo $row['staff_fname']; ?>">
                        </div>
                        <div class="col-sm-6">
                            <label for="name">Last Name</label>
                            <input type="text" class="form-control form-control-user" id="Lname" name="LName" value="<?php echo $row['staff_lname']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" name="email" id="email" class="form-control" name="email" value="<?php echo $row['staff_email']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="phone">Phone Number</label>
                        <input type="text" name="phone" id="phone" class="form-control" name="phone" value="<?php echo $row['staff_phone']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="Address">Address</label>
                        <textarea class="form-control" id="address" rows="3" name="address"><?php echo $row['staff_address']; ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="Role">Staff Role</label>
                        <input type="text" name="role" id="role" class="form-control" name="role" value="<?php echo $row['staff_role']; ?>">
                    </div>
