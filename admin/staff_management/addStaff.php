...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO staff (staff_username, staff_password, staff_fname, staff_lname, staff_email, staff_phone, staff_address, staff_role) 
    VALUES ('$username','$password','$firstName', '$lastName', '$email', '$phone', '$address', '$role')";
...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">Staff Account Registration</h1>
            ...
            <div class="container-fluid">
                ...
                <form action="" id="manage-user" method="POST">	
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="email" class="form-control" name="email">
                    </div>
                    <div class="form-group">
                        <label for="phone">Phone Number</label>
                        <input type="phone" name="phone" id="phone" class="form-control" name="phone">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="phone">Staff Role</label>
                        <input type="text" name="role" id="role" class="form-control" name="role">
                    </div>
